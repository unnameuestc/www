...
showWin: function(width, height, title, src) {
        ...
        var inntHtml = '';
        inntHtml += '<div id="mask" style="width:100%; height:100%; position:fixed; top:0; left:0; z-inde:1999;background:#cccccc; filter:alpha(opacity=0); -moz-opacity:0; -khtml-opacity: 0; opacity:0;"></div>'
